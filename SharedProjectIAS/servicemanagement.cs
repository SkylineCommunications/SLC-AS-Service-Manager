    ...
    public static class SlcServicemanagementIds
    {
        ...
        public static class Sections
        {
            public static class ServicePropertyValue
            {
                ...
                = new SectionDefinitionID(new Guid("79a261bf-f7b3-45e6-88f6-e0db12ab3bec"))
                ...
                = new FieldDescriptorID(new Guid("e4b41897-a6eb-452a-a6ad-88f11e9f9c22"));
                public static FieldDescriptorID Value
                {
                    get;
                }

                = new FieldDescriptorID(new Guid("fa59e22e-1ea6-49c2-b134-d42273134508"));
                public static FieldDescriptorID Property
                {
                    get;
                }

                = new FieldDescriptorID(new Guid("f8905e96-be94-48d2-9ebe-7bafee3c1224"));
            }
            ...
            public static class DiscreteServicePropertyValueOptions
            {
                ...
                = new SectionDefinitionID(new Guid("342bb39e-e8c2-4e82-9a97-606a942dca27"))
                { ModuleId = "(slc)servicemanagement" };
                public static FieldDescriptorID DiscreteValue
                {
                    get;
                }

                = new FieldDescriptorID(new Guid("942259dc-1708-469b-8802-c9435f9a1abc"));
            }
            ...
            public static class ServiceSpecificationInfo
            {
                ...
                public static FieldDescriptorID ServiceProperties
                {
                    get;
                }

                = new FieldDescriptorID(new Guid("2690b1d8-602e-4f6d-8bad-1e197ee8535a"));
                public static FieldDescriptorID ServiceConfiguration
                {
                    get;
                }

                = new FieldDescriptorID(new Guid("82c72b36-640b-414d-b4da-9c3fd5fe54fb"));
            }
            ...
            public static class ServicePropertyValueInfo
            {
                ...
                = new SectionDefinitionID(new Guid("77cfd79c-7b47-41aa-a476-1be4c0738537"))
                { ModuleId = "(slc)servicemanagement" };
                ...
                = new FieldDescriptorID(new Guid("c3052330-1f04-4906-bd34-cbb56141526a"));
                public static FieldDescriptorID LinkedObjectDOMModule
                {
                    get;
                }

                = new FieldDescriptorID(new Guid("681ed31b-7d57-4140-9250-c6ed78b38c16"));
            }
            ...
            public static class ServiceInfo
            {
                ...
                = new FieldDescriptorID(new Guid("48751f65-2740-4965-b178-acede95cb3e6"));
                public static FieldDescriptorID ServiceConfiguration
                {
                    get;
                }

                = new FieldDescriptorID(new Guid("040d827c-c713-461f-9f05-aeb3ef15f7de"));
                public static FieldDescriptorID RelatedOrganization
                {
                    get;
                }
            ...
            public static class ServicePropertyInfo
            {
                ...
                = new SectionDefinitionID(new Guid("6bd03e43-d23a-43f9-8d1d-f81c7e713556"))
                { ModuleId = "(slc)servicemanagement" };
                public static FieldDescriptorID Name
                {
                    get;
                ...
                = new FieldDescriptorID(new Guid("a98fbb45-fb12-4d22-b150-a27be7a7997b"));
                public static FieldDescriptorID Type
                {
                    get;
                }

                = new FieldDescriptorID(new Guid("5a1fe68d-fd16-412f-b1c5-32f63d1f99fa"));
            }
            ...
            public static class ServiceItems
            {
                ...
                public static FieldDescriptorID ServiceItemConfiguration
                {
                    get;
                }

                = new FieldDescriptorID(new Guid("9a3144ee-794d-4ea9-8888-c06d9b4789ed"));
            ...
            public static class ServiceOrderItemServiceInfo
            {
                ...
                public static FieldDescriptorID Properties
                {
                    get;
                }

                = new FieldDescriptorID(new Guid("a0b3c4f9-f9bc-41ca-a480-fe4878de45b6"));
                public static FieldDescriptorID Configuration
                {
                    get;
                }

                = new FieldDescriptorID(new Guid("d8b3971c-6331-4aac-a556-9ff378d19070"));
            }
        ...
        public static class Definitions
        {
            ...
            { ModuleId = "(slc)servicemanagement" };
            public static DomDefinitionId ServiceProperties
            {
                get;
            }

            = new DomDefinitionId(new Guid("689844f0-bbc3-430b-998a-33a0a8da7358"))
            { ModuleId = "(slc)servicemanagement" };
            public static DomDefinitionId ServicePropertyValues
            {
                get;
            }

            = new DomDefinitionId(new Guid("3f3ba92f-45dc-45ef-b6ed-5b98e2d17a33"))
            { ModuleId = "(slc)servicemanagement" };
...
namespace DomHelpers.SlcServicemanagement
{
    ...
    public partial class ServiceOrdersInstance : DomInstanceBase
    {
        ...
        /// </summary>
        public ServiceOrderInfoSection ServiceOrderInfo
        {
            get;
            set;
        }
        ...
        /// </summary>
        public IList<ServiceOrderItemsSection> ServiceOrderItems
        {
            get;
            private set;
        }
        ...
        {
            ServiceOrderInfo = new ServiceOrderInfoSection(domInstance.Sections.FirstOrDefault(section => section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceOrderInfo.Id)));
    ...
    public partial class ServiceCategoryInstance : DomInstanceBase
    {
        ...
        /// </summary>
        public ServiceCategoryInfoSection ServiceCategoryInfo
        {
            get;
            set;
        }
        ...
        protected override void InitializeProperties()
        {
            ServiceCategoryInfo = new ServiceCategoryInfoSection(domInstance.Sections.FirstOrDefault(section => section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceCategoryInfo.Id)));
        }
    }
    ...
    public partial class ServiceConfigurationInstance : DomInstanceBase
    {
        ...
        /// </summary>
        public IList<ServiceConfigurationParametersValuesSection> ServiceConfigurationParametersValues
        {
            get;
            private set;
        }
    ...
    public partial class ServiceSpecificationsInstance : DomInstanceBase
    {
        ...
        /// </summary>
        public ServiceSpecificationInfoSection ServiceSpecificationInfo
        {
            get;
            set;
        }
        ...
        /// </summary>
        public IList<ServiceItemRelationshipSection> ServiceItemRelationship
        {
            get;
            private set;
        }
        ...
        /// </summary>
        public IList<ServiceItemsSection> ServiceItems
        {
            get;
            private set;
        }
        ...
        protected override void InitializeProperties()
        {
            ServiceSpecificationInfo = new ServiceSpecificationInfoSection(domInstance.Sections.FirstOrDefault(section => section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceSpecificationInfo.Id)));
    ...
    public partial class ServicePropertiesInstance : DomInstanceBase
    {
        ...
        /// </summary>
        public IList<DiscreteServicePropertyValueOptionsSection> DiscreteServicePropertyValueOptions
        {
            get;
            private set;
        }
        ...
        /// </summary>
        public ServicePropertyInfoSection ServicePropertyInfo
        {
            get;
            set;
        }
        ...
        protected override void InitializeProperties()
        {
            ...
            ServicePropertyInfo = new ServicePropertyInfoSection(domInstance.Sections.FirstOrDefault(section => section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServicePropertyInfo.Id)));
        }
    }
    ...
    public partial class ServicePropertyValuesInstance : DomInstanceBase
    {
        ...
        /// </summary>
        public IList<ServicePropertyValueSection> ServicePropertyValue
        {
            get;
            private set;
        }
    ...
    public partial class ServicesInstance : DomInstanceBase
    {
        ...
        /// </summary>
        public ServiceInfoSection ServiceInfo
        {
            get;
            set;
        }
        ...
        protected override void InitializeProperties()
        {
            ServiceInfo = new ServiceInfoSection(domInstance.Sections.FirstOrDefault(section => section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceInfo.Id)));
            ServiceItemRelationship = domInstance.Sections.Where(section => section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceItemRelationship.Id)).Select(section => new ServiceItemRelationshipSection(section)).ToList();
            ServiceItems = domInstance.Sections.Where(section => section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceItems.Id)).Select(section => new ServiceItemsSection(section)).ToList();
        }
    }
    ...
    public partial class ServiceOrderItemsInstance : DomInstanceBase
    {
        ...
        /// </summary>
        public ServiceOrderItemServiceInfoSection ServiceOrderItemServiceInfo
        {
            get;
            set;
        }
        ...
        /// </summary>
        public ServiceOrderItemInfoSection ServiceOrderItemInfo
        {
            get;
            set;
        }
        ...
        protected override void InitializeProperties()
        {
            ServiceOrderItemServiceInfo = new ServiceOrderItemServiceInfoSection(domInstance.Sections.FirstOrDefault(section => section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceOrderItemServiceInfo.Id)));
            ServiceOrderItemInfo = new ServiceOrderItemInfoSection(domInstance.Sections.FirstOrDefault(section => section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceOrderItemInfo.Id)));
        }
    }
}
//------------------------------------------------------------------------------
...
namespace DomHelpers.SlcServicemanagement
{
    ...
    public partial class ServicePropertyValueSection : DomSectionBase
    {
        ...
        public ServicePropertyValueSection(Section section) : base(SlcServicemanagementIds.Sections.ServicePropertyValue.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServicePropertyValue.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServicePropertyValue.Id)}'", nameof(section));
            }
    ...
    public partial class DiscreteServicePropertyValueOptionsSection : DomSectionBase
    {
        ...
        public DiscreteServicePropertyValueOptionsSection(Section section) : base(SlcServicemanagementIds.Sections.DiscreteServicePropertyValueOptions.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.DiscreteServicePropertyValueOptions.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.DiscreteServicePropertyValueOptions.Id)}'", nameof(section));
            }
    ...
    public partial class ServiceOrderInfoSection : DomSectionBase
    {
        ...
        public ServiceOrderInfoSection(Section section) : base(SlcServicemanagementIds.Sections.ServiceOrderInfo.Id)
        {
            if (section == null)
            {
                OrderContact = new List<Guid>();
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceOrderInfo.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServiceOrderInfo.Id)}'", nameof(section));
            }
        ...
        /// </list>
        /// </remarks>
        public IList<Guid> OrderContact
        {
            get;
            private set;
        }
    ...
    public partial class ServiceSpecificationInfoSection : DomSectionBase
    {
        ...
        public ServiceSpecificationInfoSection(Section section) : base(SlcServicemanagementIds.Sections.ServiceSpecificationInfo.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceSpecificationInfo.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServiceSpecificationInfo.Id)}'", nameof(section));
            }
        ...
        /// <summary>
        /// Gets or sets the ServiceConfiguration field of the DOM Instance.
        /// </summary>
        /// <remarks>
        /// When retrieving the value:
        /// <list type="bullet">
        ...
        public Guid? ServiceConfiguration
        {
            ...
            set
            {
                if (value == null)
                {
                    section.RemoveFieldValueById(SlcServicemanagementIds.Sections.ServiceSpecificationInfo.ServiceConfiguration);
                }
                else
                {
                    section.AddOrUpdateValue(SlcServicemanagementIds.Sections.ServiceSpecificationInfo.ServiceConfiguration, (Guid)value);
                }
            }
        }
    }
    ...
    public partial class ServicePropertyValueInfoSection : DomSectionBase
    {
        ...
        public ServicePropertyValueInfoSection(Section section) : base(SlcServicemanagementIds.Sections.ServicePropertyValueInfo.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServicePropertyValueInfo.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServicePropertyValueInfo.Id)}'", nameof(section));
            }
    ...
    public partial class ServiceInfoSection : DomSectionBase
    {
        ...
        public ServiceInfoSection(Section section) : base(SlcServicemanagementIds.Sections.ServiceInfo.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceInfo.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServiceInfo.Id)}'", nameof(section));
            }
        ...
        public String Name
        {
            get
            {
                var wrapper = section.GetValue<String>(SlcServicemanagementIds.Sections.ServiceInfo.Name);
                if (wrapper != null)
                {
                    return (String)wrapper.Value;
                }
            ...
            set
            {
                if (value == null)
                {
                    section.RemoveFieldValueById(SlcServicemanagementIds.Sections.ServiceInfo.Name);
                }
                else
                {
                    section.AddOrUpdateValue(SlcServicemanagementIds.Sections.ServiceInfo.Name, (String)value);
                }
            }
        }
        ...
        public Guid? ServiceConfiguration
        {
            ...
            set
            {
                if (value == null)
                {
                    section.RemoveFieldValueById(SlcServicemanagementIds.Sections.ServiceInfo.ServiceConfiguration);
                }
                else
                {
                    section.AddOrUpdateValue(SlcServicemanagementIds.Sections.ServiceInfo.ServiceConfiguration, (Guid)value);
                }
            }
        }
    ...
    public partial class ServiceItemRelationshipSection : DomSectionBase
    {
        ...
        public ServiceItemRelationshipSection(Section section) : base(SlcServicemanagementIds.Sections.ServiceItemRelationship.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceItemRelationship.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServiceItemRelationship.Id)}'", nameof(section));
            }
    ...
    public partial class ServiceConfigurationParametersValuesSection : DomSectionBase
    {
        ...
        public ServiceConfigurationParametersValuesSection(Section section) : base(SlcServicemanagementIds.Sections.ServiceConfigurationParametersValues.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceConfigurationParametersValues.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServiceConfigurationParametersValues.Id)}'", nameof(section));
            }
    ...
    public partial class ServiceCategoryInfoSection : DomSectionBase
    {
        ...
        public ServiceCategoryInfoSection(Section section) : base(SlcServicemanagementIds.Sections.ServiceCategoryInfo.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceCategoryInfo.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServiceCategoryInfo.Id)}'", nameof(section));
            }
    ...
    public partial class ServicePropertyInfoSection : DomSectionBase
    {
        ...
        public ServicePropertyInfoSection(Section section) : base(SlcServicemanagementIds.Sections.ServicePropertyInfo.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServicePropertyInfo.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServicePropertyInfo.Id)}'", nameof(section));
            }
    ...
    public partial class ServiceOrderItemsSection : DomSectionBase
    {
        ...
        public ServiceOrderItemsSection(Section section) : base(SlcServicemanagementIds.Sections.ServiceOrderItems.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceOrderItems.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServiceOrderItems.Id)}'", nameof(section));
            }
    ...
    public partial class ServiceItemsSection : DomSectionBase
    {
        ...
        public ServiceItemsSection(Section section) : base(SlcServicemanagementIds.Sections.ServiceItems.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceItems.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServiceItems.Id)}'", nameof(section));
            }
        ...
        /// <summary>
        /// Gets or sets the ServiceItemConfiguration field of the DOM Instance.
        /// </summary>
        /// <remarks>
        /// When retrieving the value:
        /// <list type="bullet">
        ...
        public Guid? ServiceItemConfiguration
        {
            ...
            set
            {
                if (value == null)
                {
                    section.RemoveFieldValueById(SlcServicemanagementIds.Sections.ServiceItems.ServiceItemConfiguration);
                }
                else
                {
                    section.AddOrUpdateValue(SlcServicemanagementIds.Sections.ServiceItems.ServiceItemConfiguration, (Guid)value);
                }
            }
        }
    ...
    public partial class ServiceOrderItemServiceInfoSection : DomSectionBase
    {
        ...
        public ServiceOrderItemServiceInfoSection(Section section) : base(SlcServicemanagementIds.Sections.ServiceOrderItemServiceInfo.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceOrderItemServiceInfo.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServiceOrderItemServiceInfo.Id)}'", nameof(section));
            }
        ...
        public Guid? Configuration
        {
            ...
            set
            {
                if (value == null)
                {
                    section.RemoveFieldValueById(SlcServicemanagementIds.Sections.ServiceOrderItemServiceInfo.Configuration);
                }
                else
                {
                    section.AddOrUpdateValue(SlcServicemanagementIds.Sections.ServiceOrderItemServiceInfo.Configuration, (Guid)value);
                }
            }
        }
    }
    ...
    public partial class ServiceOrderItemInfoSection : DomSectionBase
    {
        ...
        public ServiceOrderItemInfoSection(Section section) : base(SlcServicemanagementIds.Sections.ServiceOrderItemInfo.Id)
        {
            if (section == null)
            {
                return;
            ...
            if (!section.SectionDefinitionID.Equals(SlcServicemanagementIds.Sections.ServiceOrderItemInfo.Id))
            {
                throw new ArgumentException($"The given section, is not of type '{nameof(SlcServicemanagementIds.Sections.ServiceOrderItemInfo.Id)}'", nameof(section));
            }
